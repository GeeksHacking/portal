...
namespace GeeksHackingPortal.Infra.Stacks;
...
public class BootstrapStack : Stack
{
    public BootstrapStack()
    {
        ...
        var stateBucket = new Bucket(
            "hackomania-pulumi-state", // Legacy name
            new BucketArgs
            {
                Name = "hackomania-pulumi-state", // Legacy name
        ...
        var workloadIdentityProvider = new WorkloadIdentityPoolProvider(
            ...
            new WorkloadIdentityPoolProviderArgs
            {
                ...
                Disabled = false,
                AttributeCondition = """
                attribute.repository == "GeeksHacking/portal"
                """,
            ...
            new IAMBindingArgs
            {
                ...
                Members = new[]
                {
                    workloadIdentityPool.Name.Apply(poolName =>
                        $"principalSet://iam.googleapis.com/{poolName}/attribute.repository/GeeksHacking/portal"
                    ),
                },
            }
        );
