...
public class ChallengeSelectionJintTests
{
    ...
    public async Task SubmitChallenge_WithTeamSizeRequirement_ShouldEnforce()
    {
        ...
        var team = await teamResponse.Content.ReadFromJsonAsync<JintTeamResponse>();
    ...
    public async Task SubmitChallenge_WithMaxTeamsLimit_ShouldEnforce()
    {
        ...
        var team1 = await teamResponse1.Content.ReadFromJsonAsync<JintTeamResponse>();
        ...
        var team2 = await teamResponse2.Content.ReadFromJsonAsync<JintTeamResponse>();
...
public class JintChallengeResponse
{
    public Guid Id { get; set; }
